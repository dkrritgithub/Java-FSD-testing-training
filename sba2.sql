...
values('James','Stewart','M'),('Deborah','Kerr','F'),('Peter','OToole','M'),
('Robert','De Niro','M'),('F.Murray','Abraham','M'),('Harrison','Ford','M'),
('Nicole','Kidman','F'),('Stephen','Baldwin','M'),('Jack','Nicholson','M'),
('Mark','Wahlberg','M'),('Woody','Allen','M'),('Claire','Danes','F'),
('Tim','Robbins','M'),('Kevin','Spacey','M'),('Kate','Winslet','F'),
('Robin','Williams','M'),('Jon','Voight','M'),('Ewan','McGregor','M'),
('Christian','Bale','M'),('Maggie','Gyllenhaal','F'),('Dev','Patel','M'),
('Sigourney','Weaver','F'),('David','Aston','M'),('Ali','Astin','F');
select * from actor;
...
values(101,901,'John Scottie Ferguson'),(102,902,'Miss Giddens'),(103,903,'T.E. Lawrence'),(104,904,'Michael'),
(105,905,'Antonio Salieri'),(106,906,'Rick Deckard'),(107,907,'Alice Harford'),(108,908,'McManus'),(110,910,'Eddie Adams'),
(111,911,'Alvy Singer'),(112,912,'San'),(113,913,'Andy Dufresne'),(114,914,'Lester Burnham'),(115,915,'Rose DeWitt Bukater'),
(116,916,'Sean Maguire'),(117,917,'Ed'),(118,918,'Renton'),(120,920,'Elizabeth Darko'),(121,921,'Older Jamal'),(122,922,'Ripley'),
(114,923,'Bobby Darin'),(109,909,'J.J. Gittes'),(119,919,'Alfred Borden');
select * from movie_cast;

insert into reviewer(rev_name)
values('Righty Sock'),('Jack Malvern'),('Flagrant Baronessa'),
('Alec Shaw'),(null),('Victor Woeltjen'),('Simon Wright'),('Neal Wruck'),
('Paul Monks'),('Mike Salvati'),(null),('Wesley S. Walker'),('Sasha Goldshtein'),
('Josh Cates'),('Krug Stillo'),('Scott LeBrun'),('Hannah Steele'),
...
values(922,1001),(917,1002),(903,1002),(912,1003),(911,1005),(908,1006),(913,1006),(926,1007),(928,1007),(918,1007),(921,1007),
(902,1008),(923,1009),(907,1010),(927,1010),(901,1010),(914,1011),(906,1012),(904,1013);

select * from movie_generes;
...
(924,9006,7.3,null),(908,9007,8.6,779489),(909,9008,null,227235),(910,9009,3,195961),(911,9010,8.1,203875),
(912,9011,8.4,null),(914,9013,7,862618),(915,9001,7.7,830095),(916,9014,4,642132),(925,9015,7.7,81328),
(918,9016,null,580301),(920,9017,8.1,609451),(921,9018,8,667758),
...
select m.mov_title from movie m,movie_generes mg,genres g where 
...
select a.* from actor a, movie m,movie_cast c where
a.act_id=c.act_id and
m.mov_id=c.mov_id and
m.mov_title='deliverance';
...
SELECT distinct mov_title, mov_year, mov_dt_rel, dir_fname, dir_lname,act_fname, act_lname
...
AND e.rev_name ='Neal Wruck';-- Write a query in SQL to list the Horror movies------
